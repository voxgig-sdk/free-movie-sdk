...
|---|---|---|
| `ts/` | @voxgig-sdk/free-movie-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/free-movie-sdk \
      --repository voxgig-sdk/free-movie-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/free-movie-sdk` shows it, and
`npm trust revoke @voxgig-sdk/free-movie-sdk --id=<id>` removes it.
