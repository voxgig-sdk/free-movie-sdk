...
class FreeMovieCacheFeature extends FreeMovieBaseFeature
{
    ...
    private function _through(FreeMovieContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
