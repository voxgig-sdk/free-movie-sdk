...
class FreeMovieNetsimFeature extends FreeMovieBaseFeature
{
    ...
    private function _simulate(FreeMovieContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FreeMovieContext $ctx, array $applied): void
    {
        $client = $this->client;
