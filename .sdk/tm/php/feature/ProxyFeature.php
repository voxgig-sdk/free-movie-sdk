...
class FreeMovieProxyFeature extends FreeMovieBaseFeature
{
    ...
    public function init(FreeMovieContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FreeMovieContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
