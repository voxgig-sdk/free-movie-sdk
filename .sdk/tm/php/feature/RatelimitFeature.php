...
// FreeMovie SDK ratelimit feature
...
class FreeMovieRatelimitFeature extends FreeMovieBaseFeature
{
    ...
    private function _acquire(FreeMovieContext $ctx): void
    {
    ...
    private function _track(FreeMovieContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
