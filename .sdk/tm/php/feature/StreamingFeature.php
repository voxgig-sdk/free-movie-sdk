...
// FreeMovie SDK streaming feature
...
class FreeMovieStreamingFeature extends FreeMovieBaseFeature
{
    ...
    private function _iterate(FreeMovieResult $result): \Generator
    {
    ...
    private function _streamable(FreeMovieContext $ctx): bool
    {
