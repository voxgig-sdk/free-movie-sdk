...
// FreeMovie SDK utility: fetcher

class FreeMovieFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FreeMovieSDK/1.0)';
    ...
    public static function call(FreeMovieContext $ctx, string $fullurl, array $fetchdef): array
    {
