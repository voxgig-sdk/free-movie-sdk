...
class FreeMovieGraphql
{
    ...
    // equivalent.
    public static function body(FreeMovieContext $ctx): mixed
    {
    ...
    public static function errors(FreeMovieContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
