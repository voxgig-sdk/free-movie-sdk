...
// FreeMovie SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FreeMovieMakeRequest
{
    public static function call(FreeMovieContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FreeMovieResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FreeMovieResponse($fetched);
        } else {
