...
from projectname_sdk.core.control import FreeMovieControl
...
class FreeMovieContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FreeMovieSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FreeMovieResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FreeMovieResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FreeMovieError(code, msg, self)
