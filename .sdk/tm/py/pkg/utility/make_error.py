# FreeMovie SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, FreeMovieError):
        errmsg = err.msg
    ...
    msg = "FreeMovieSDK: " + opname + ": " + errmsg
    ...
    sdk_err = FreeMovieError("", msg, ctx)
