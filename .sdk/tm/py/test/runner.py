...
class FreeMovieTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeMovieTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FreeMovieTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FreeMovieTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
