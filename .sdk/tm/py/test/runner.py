...
class FreeMovieTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeMovieTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FreeMovieTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FreeMovieTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
