...
from projectname_sdk import FreeMovieSDK
from projectname_sdk.core.spec import FreeMovieSpec
from projectname_sdk.core.result import FreeMovieResult
from projectname_sdk.core.response import FreeMovieResponse
from projectname_sdk.core.operation import FreeMovieOperation
from projectname_sdk.core.error import FreeMovieError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FreeMovieBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return FreeMovieError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FreeMovieSDK.test(None, None)
        ...
        class TestInitFeature(FreeMovieBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FreeMovieBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FreeMovieSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FreeMovieSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FreeMovieSDK.test(None, setup_opts)
