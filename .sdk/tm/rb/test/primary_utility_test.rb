...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = FreeMovieOmni.make_runner(TEST_JSON_FILE, FreeMovieSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : FreeMovieOmni.errify(err)
    end
