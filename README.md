...
This API provides access to a wide range of movie and series information without requiring API keys.

Learn more about Free Movie API at [github.com/TelegramPlayGround/Free-Movie-Series-DB-API](https://github.com/TelegramPlayGround/Free-Movie-Series-DB-API).
...
This SDK exposes the API as a small set of **semantic entities** — Movie and Search — that you
