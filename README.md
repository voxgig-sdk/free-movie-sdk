...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/free-movie` | `npm install @voxgig-sdk/free-movie` |
| Python | `voxgig-sdk-free-movie` | `pip install voxgig-sdk-free-movie` |
| PHP | `voxgig-sdk/free-movie` | `composer require voxgig-sdk/free-movie` |
| Golang | `github.com/voxgig-sdk/free-movie-sdk/go` | `go get github.com/voxgig-sdk/free-movie-sdk/go` |
| Ruby | `voxgig-sdk-free-movie` | `gem install voxgig-sdk-free-movie` |
| Lua | `voxgig-sdk-free-movie` | `luarocks install voxgig-sdk-free-movie` |
