...
func registerSDKWords(r *eng.Registry, client *sdk.FreeMovieSDK) {
...
func runOp(client *sdk.FreeMovieSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
