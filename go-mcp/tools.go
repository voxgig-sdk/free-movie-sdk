...
type Args struct {
	Entity string         `json:"entity" jsonschema:"movie | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FreeMovieSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-movie_list",
		Description: "List records from FreeMovie. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "free-movie_load",
		Description: "Load a single record from FreeMovie. " +
...
func runOp(client *sdk.FreeMovieSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FreeMovieSDK, name string) (sdk.FreeMovieEntity, error) {
