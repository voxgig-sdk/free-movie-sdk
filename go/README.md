...
The Golang SDK for the FreeMovie API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/free-movie-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/free-movie-sdk=../path/to/github.com/voxgig-sdk/free-movie-sdk
```
...
```
github.com/voxgig-sdk/free-movie-sdk/
...
The root package (`github.com/voxgig-sdk/free-movie-sdk`) re-exports everything needed
