# FreeMovie Golang SDK Reference

Complete API reference for the FreeMovie Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *FreeMovieSDK`
...
#### `Movie(data map[string]any) FreeMovieEntity`

Create a new `Movie` entity instance. Pass `nil` for no initial data.

#### `Search(data map[string]any) FreeMovieEntity`
