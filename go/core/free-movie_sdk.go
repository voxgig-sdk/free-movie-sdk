...
func (sdk *FreeMovieSDK) OptionsMap() map[string]any {
...
func (sdk *FreeMovieSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FreeMovieSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FreeMovieSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeMovieSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FreeMovieSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FreeMovieSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FreeMovieSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FreeMovieSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FreeMovieSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FreeMovieSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
