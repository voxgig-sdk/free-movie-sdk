...
func NewMovieEntity(client *core.FreeMovieSDK, entopts map[string]any) *MovieEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MovieEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *MovieEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MovieEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MovieEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
