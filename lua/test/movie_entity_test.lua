...
describe("MovieEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FREEMOVIE_TEST_MOVIE_ENTID JSON to run live")
      return
    end
...
function movie_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FREEMOVIE_TEST_MOVIE_ENTID")
