...
The PHP SDK for the FreeMovie API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Movie(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->FreeMovie(null)->load(
    ["id" => "test01"], null
);
