...
The PHP SDK for the FreeMovie API — an entity-oriented client using PHP conventions.
...
```
php/
├── freemovie_sdk.php          -- Main SDK class
...
The main class (`freemovie_sdk.php`) exports the SDK class
