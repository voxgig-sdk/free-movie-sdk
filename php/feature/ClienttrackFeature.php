...
// FreeMovie SDK clienttrack feature
...
class FreeMovieClienttrackFeature extends FreeMovieBaseFeature
{
    ...
    public function PostConstruct(FreeMovieContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FreeMovie-SDK';
