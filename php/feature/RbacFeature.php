...
class FreeMovieRbacFeature extends FreeMovieBaseFeature
{
    ...
    private function _required(FreeMovieContext $ctx): ?string
    {
    ...
    private function _reject(FreeMovieContext $ctx, string $required): void
    {
    ...
    private function _track(FreeMovieContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
