...
// FreeMovie SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FreeMovieTestFeature extends FreeMovieBaseFeature
{
    ...
    public function init(FreeMovieContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FreeMovieContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FreeMovieParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FreeMovieContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FreeMovieContext $ctx, $op, $args): array
    {
