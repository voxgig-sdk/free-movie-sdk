...
class FreeMovieTimeoutFeature extends FreeMovieBaseFeature
{
    ...
    private function _with_timeout(FreeMovieContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FreeMovieContext $_ctx, float $ms): void
    {
        $client = $this->client;
