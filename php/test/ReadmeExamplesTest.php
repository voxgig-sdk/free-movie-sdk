...
// FreeMovie SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FreeMovieSDK::test)
...
{
    private const SDK_CLASS = 'FreeMovieSDK';
    ...
    private const SDK_BASE = 'freemovie_sdk';
