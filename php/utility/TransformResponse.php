...
// FreeMovie SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FreeMovieTransformResponse
{
    public static function call(FreeMovieContext $ctx): mixed
    {
        ...
        $transform = FreeMovieHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
