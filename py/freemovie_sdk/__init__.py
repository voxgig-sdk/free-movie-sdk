...
from freemovie_sdk.utility import register

# Load features
from freemovie_sdk.feature.base_feature import FreeMovieBaseFeature
from freemovie_sdk.features import _has_feature, _make_feature
...
class FreeMovieSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FreeMovieUtility()
        self._utility = utility

        from freemovie_sdk.config import shared_config
    ...
    def get_utility(self):
        return FreeMovieUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FreeMovieSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Movie(self, data=None) -> "MovieEntity":
        ...
        from freemovie_sdk.entity.movie_entity import MovieEntity
        return MovieEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from freemovie_sdk.entity.search_entity import SearchEntity
