...
class FreeMovieTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FreeMovieTestRunner.getenv("FREEMOVIE_TEST_LIVE")
        override = FreeMovieTestRunner.getenv("FREEMOVIE_TEST_OVERRIDE")
        ...
        explain = FreeMovieTestRunner.getenv("FREEMOVIE_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["FREEMOVIE_TEST_EXPLAIN"] = explain
