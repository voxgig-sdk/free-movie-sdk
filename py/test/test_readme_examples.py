# FreeMovie SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FreeMovieSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FreeMovieSDK(...) and FreeMovieSDK.test(...) become
#      FreeMovieSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "freemovie_sdk"
_SDK_CLASS = "FreeMovieSDK"
