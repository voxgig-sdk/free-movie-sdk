# FreeMovie TypeScript SDK



The TypeScript SDK for the FreeMovie API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Movie()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `FreeMovieSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `FreeMovieSDK.test(testopts?, sdkopts?)` | `FreeMovieSDK` | Create a test-mode client. |
...
| `client` | `client(): FreeMovieSDK` | Return the parent SDK client. |
...
free-movie/
├── src/
│   ├── FreeMovieSDK.ts        # Main SDK class
