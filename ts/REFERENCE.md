# FreeMovie TypeScript SDK Reference

Complete API reference for the FreeMovie TypeScript SDK.
...
```ts
new FreeMovieSDK(options?: object)
```
...
#### `FreeMovieSDK.test(testopts?, sdkopts?)`
...
**Returns:** `FreeMovieSDK` instance in test mode.
...
Return the parent `FreeMovieSDK` instance.
