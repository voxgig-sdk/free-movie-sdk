...
(0, node_test_1.describe)('SearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FreeMovieSDK({
...
function liveScenariosActive() { return false && process.env.FREE_MOVIE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FreeMovieSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FREE_MOVIE_TEST_SEARCH_ENTID'];
    ...
    const client = new __1.FreeMovieSDK({
        base: 'http://localhost:8080',
