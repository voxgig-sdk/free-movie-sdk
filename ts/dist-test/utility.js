...
function envOverride(m) {
    if ('TRUE' === process.env.FREE_MOVIE_TEST_LIVE ||
        'TRUE' === process.env.FREE_MOVIE_TEST_OVERRIDE) {
    ...
    m.FREE_MOVIE_TEST_EXPLAIN = process.env.FREE_MOVIE_TEST_EXPLAIN || m.FREE_MOVIE_TEST_EXPLAIN;
    return m;
}
